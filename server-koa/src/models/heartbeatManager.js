...
export class HeartbeatManager {
  constructor(deviceRegistry) {
    ...
    this.heartbeatTimeout = Number.parseInt(process.env.HEARTBEAT_TIMEOUT) || 60_000 // 1分钟
    this.cleanupInterval = Number.parseInt(process.env.CLEANUP_INTERVAL) || 1_800_000 // 30分钟
